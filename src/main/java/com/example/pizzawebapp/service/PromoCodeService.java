...
public class PromoCodeService {
     ...
     * @param cartTotal  The total amount of the cart before applying the promo code.
     * @return The discounted total after applying the promo code.
     * @throws IllegalArgumentException If the promo code is invalid or cannot be applied.
     */
